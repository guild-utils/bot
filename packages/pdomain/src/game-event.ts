...
export abstract class GameEventBase<kindT extends GameEventKind>{
    constructor(alwaysNotify:boolean,header:string[]){
...
export class GameEventPeriodical extends GameEventBase<"periodical">{
    constructor(alwaysNotify:boolean,header:string[],timing:GameEventTimingPeriodical,public readonly desc:GameEventDesc){
        super(alwaysNotify,header)
        this.timing=timing
    }
...
export class GameEventFixed extends GameEventBase<"fixed">{
    constructor(alwaysNotify:boolean,header:string[],timing:GameEventTimingFixed,public readonly desc:GameEventDesc){
        super(alwaysNotify,header)
...
export interface GameEventRepository<CollectionGroupIdT,HKTCollectionNameT extends HKTCollectionName>{
    ...
    put(collectionGroupId:CollectionGroupIdT,collectionId:HKTCollectionNameU<HKTCollectionNameT>,event:GameEvent):Promise<void>
