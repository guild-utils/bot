...
export default class extends Language {
  protected KLASA_MESSAGES = {
    ...
    COMMAND_HELP_ALL_FOOTER: (msg: KlasaMessage)=>`${msg.guildSettings.get("prefix")}help caregoryでカテゴリの情報が確認できます。(例: ${msg.guildSettings.get("prefix")}help General)`,
    COMMAND_HELP_CATEGORY_FOOTER:(msg: KlasaMessage)=>`${msg.guildSettings.get("prefix")}help caregory/subcategoryでサブカテゴリの情報が確認できます。(例: ${msg.guildSettings.get("prefix")}help General/Chat Bot Info)`,
    COMMAND_HELP_SUB_CATEGORY_FOOTER:(msg: KlasaMessage)=>`${msg.guildSettings.get("prefix")}help commandでコマンドの情報が確認できます。(例: ${msg.guildSettings.get("prefix")}help help)`,
  };
