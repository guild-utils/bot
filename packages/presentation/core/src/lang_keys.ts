...
export type GUJ_CORE_LANG_TYPE = {
  ...
  APPLIED_VOICE_CONFIG_TITLE: string;
};
...
export const META_COMMAND_DELETED = "META_COMMAND_DELETED";
export const APPLIED_VOICE_CONFIG_TITLE = "APPLIED_VOICE_CONFIG_TITLE";
